...
let strArray = search.split("=");
  console.log('search',strArray);
  // Place holder for functionality to work in the Stubs
  fetchAdventureDetails(strArray[1]);
  return strArray[1];
}
...
function addBootstrapPhotoGallery(images) {
  ...
  images.forEach((image,imageIndex) => {
    ...
    carouselItemElement.className = `carousel-item${activeClass}`;
    ...
    class="activity-card-image pb-3 pb-md-0"
    />`;
    document.getElementById("carousel-inner").appendChild(carouselItemElement);
